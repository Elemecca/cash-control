...
#define USB_DEVICE_DESCRIPTOR       usb_app_device_desc
#define USB_CONFIG_DESCRIPTOR_MAP   usb_app_config_descs
#define USB_STRING_DESCRIPTOR_FUNC  usb_app_get_string

/* HID Configuration functions. See usb_hid.h for documentation. */
#define USB_HID_DESCRIPTOR_FUNC         usb_app_get_hid_descriptor
#define USB_HID_REPORT_DESCRIPTOR_FUNC  usb_app_get_hid_report_descriptor
...
#define UNKNOWN_SETUP_REQUEST_CALLBACK  usb_app_unknown_setup_request_cb
...
//#define USB_RESET_CALLBACK              usb_app_reset_cb
...
// this fixes an MStack_HID bug:
// usb_hid.c defines this as `MIN` but uses it as `min`
// TODO: this should be fixed upstream and removed
